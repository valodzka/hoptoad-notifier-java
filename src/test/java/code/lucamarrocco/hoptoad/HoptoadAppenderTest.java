...
public class HoptoadAppenderTest {
	...
	public void testNewAppenderWithApiKey() {
		final HoptoadAppender appender = new HoptoadAppender(HoptoadNotifierTest.KEY);
	...
	public void testNewAppenderWithApiKeyAndBacktrace() {
		final HoptoadAppender appender = new HoptoadAppender(HoptoadNotifierTest.KEY, new Backtrace());
	...
	public void testNotyfyThrowable$UseQuiteBacktrace() {
		final HoptoadAppender appender = new HoptoadAppender(HoptoadNotifierTest.KEY, new QuietRubyBacktrace());
	...
	public void testNotyfyThrowable$UseRubyBacktrace() {
		final HoptoadAppender appender = new HoptoadAppender(HoptoadNotifierTest.KEY, new RubyBacktrace());
	...
	public void testNotyfyThrowable$UseSwitchBacktrace() {
		...
		final HoptoadAppender appender = new HoptoadAppender(HoptoadNotifierTest.KEY, switchBacktrace);
